...
for(i in 1:nrow(summary.dt)){
  ...
  if(grepl("fusions",summary.dt$type[i])){
        summary.dt$type[i]=gsub("fusions",basebutton,summary.dt$type[i])
        summary.dt$type[i]=gsub("thisValue","fusions",summary.dt$type[i])
  }
