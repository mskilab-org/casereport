...
function hideImgs() {
         ...
         var scrolls = DivId.getElementsByTagName("divScroll");
         for(var j=0, sLen=scrolls; j<sLen; j++) {
            if(scrolls[j].id != "" && scrolls[j].style.display != "none"){
              scrolls[j].style.display = "none";
            }
          }
        }
</script>
