...
```{r, Oneness_twoness, results = "asis", echo = FALSE, out.width = "100%", fig.align = "center"}
ot.plot = file.path(params$outdir, "onenesstwoness.log.dat.png")
ot.plot.2 = file.path(params$outdir, "onenesstwoness.prop.dat.png")
oneness.plot = file.path(params$outdir, "Oneness.png")
twoness.plot = file.path(params$outdir, "Twoness.png")
...
if (file.exists(file.path(params$outdir, "hrdetect.rds"))){
...
## if (file.exists(file.path(params$outdir, "ppfit.hist.png"))){
##     cat(
##         paste0("![](", file.path(params$outdir, "ppfit.hist.png"),")"), "\n\n"
##     )
## }
```
