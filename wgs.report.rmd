...
```{r, total-cn, results = "asis", out.width = "100%", fig.align = "center"}
knitr::include_graphics(file.path(params$outdir, "cn.pp.png"))
```

## Allelic CN

```{r, allelic-cn, results = "asis", out.width = "45", fig.show = "hold", fig.align = "center"}
knitr::include_graphics(c(file.path(params$outdir, "allele.scatter.png"), file.path(params$outdir, "allele.pp.png")))
```
