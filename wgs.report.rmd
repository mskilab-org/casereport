...
dat = driver.fusions.dt[, .(genes, walk.id, driver.name, chroms, maxcn, total.aa, gene.pc, ev.id, ev.type)] ## %>% kbl() %>% kable_styling()
...
dat = other.fusions.dt[, .(genes, walk.id, chroms, maxcn, total.aa, gene.pc, ev.id, ev.type)] 
