...
Copy number alterations (CNA) are defined as CN at most `r readRDS(file.path(params$outdir, "cmd.args.rds"))$del_thresh` times ploidy (deletions) or at least `r readRDS(file.path(params$outdir, "cmd.args.rds"))$amp_thresh` times ploidy (amplifications). 
...
```{r, SNV-signature,  dropAboveExp=TRUE, results = "asis", echo = FALSE, out.width="100%", fig.align = "center"}
