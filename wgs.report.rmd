...
genome shows copy number alterations (CNA, < `r params$del_thresh` or
>= ``) Over the whole
genome, the number of somatic SNV/INDEL is xx, or Tumor Mutation
Burden (TMB) of xx per Mbp. The total junction burden is xx.
